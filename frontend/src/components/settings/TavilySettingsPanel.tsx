  ...
  return (
    <>
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            type="password"
            placeholder={
              tavilyKeySet ? t('settings.tavily.placeholderConfigured') : 'tvly-xxxxxxxxxxxxxxxx'
            }
            value={tavilyKey}
        ...
        <p className="text-[11px] text-text-secondary mt-1.5">
          ...
          {tavilyKeySet && (
            <span className="ml-2 text-accent-green">{t('settings.tavily.configured')}</span>
          )}
        </p>
        <p className="text-[11px] text-text-secondary mt-1">{t('settings.tavily.keepOrClear')}</p>
        {saveError && (
      ...
      <div className="pt-2 flex items-center gap-3">
        <Button
          data-testid="settings-tavily-save"
          variant="primary"
          className="min-h-11"
        ...
        {tavilyKeySet && (
          <Button
            data-testid="settings-tavily-clear"
            variant="ghost"
            className="min-h-11"
